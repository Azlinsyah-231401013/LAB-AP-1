...
int main() {
    int a, b;  // Deklarasi variabel untuk menyimpan dua integer

    system("CLS");  // Membersihkan layar konsol (tidak selalu bekerja di semua lingkungan)

    // Assignment Operator (=)
    a = 3;  // Meng-assign nilai 3 ke variabel a
    b = 5;  // Meng-assign nilai 5 ke variabel b
